/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 462336f8a7084931f720ea455894a029)
// Runtime types generated with workerd@1.20260114.0 2024-09-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RenderCoordinator" | "SessionDurableObject";
	}
	interface Env {
		ENVIRONMENT: "production" | "staging";
		SO_ACCESS_KEY: string;
		WORKER_URL: string;
		RENDO: DurableObjectNamespace<import("./src/index").RenderCoordinator>;
		SESSIONS: DurableObjectNamespace<import("./src/index").SessionDurableObject>;
		R2_THUMBS: R2Bucket;
		R2_SANDBOX: R2Bucket;
		ASSETS: Fetcher;
	}
