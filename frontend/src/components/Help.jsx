...
<script><![CDATA[
  ...
  const BTLDR = {
    ...
    isPreview: n===0&&SEED===0n,   // True when rendering covers for bootloader: and objkt
  ...
  ((BTLDR) => {
    ...
    // YOUR INJECTED GENERATOR CODE ENDS HERE
        ...
        <div className="best-practices">
          ...
          <div className="practice-item">
            <h4><RefreshCw size={18} className="inline-icon" /> Optimize for Preview & Editions</h4>
            <p>Use <code>BTLDR.isPreview</code> to customise covers on bootloader: and objkt, and <code>BTLDR.iterationNumber</code> to create variations that evolve across the edition</p>
          </div>
        </div>
