...
def test_basic_generator_deletion():
    ...
    """
    scenario = sp.test_scenario("Basic Generator Deletion", [svg_js, randomiser])
    ...
    contract.delete_generator(0, _sender=bob, _valid=False, _exception="ONLY_AUTHOR")

    scenario.h2("Author can delete generator")
    contract.delete_generator(0, _sender=alice)
...
def test_cannot_delete_generator_with_tokens():
    ...
    scenario = sp.test_scenario(
        "Cannot Delete Generator with Tokens", [svg_js, randomiser]
    )
    ...
    contract.create_generator(
        ...
        description=sp.bytes(
            "0x54657374696e672064656c6574696f6e207769746820746f6b656e73"
        ),
        code=sp.bytes("0x636f6e736f6c652e6c6f67282254657374"),
        author_bytes=sp.bytes("0x416c696365"),
        reserved_editions=5,
    ...
    contract.delete_generator(
        0, _sender=alice, _valid=False, _exception="TOKENS_MINTED"
    )
...
def test_cannot_delete_generator_with_airdropped_tokens():
    ...
    """
    scenario = sp.test_scenario(
        "Cannot Delete Generator with Airdropped Tokens", [svg_js, randomiser]
    )
    ...
    contract.create_generator(
        ...
        description=sp.bytes(
            "0x54657374696e672064656c6574696f6e207769746820616972647266"
        ),
        code=sp.bytes("0x636f6e736f6c652e6c6f67282254657374"),
        author_bytes=sp.bytes("0x416c696365"),
        reserved_editions=5,
...
def test_delete_generator_with_sale_configuration():
    ...
    """
    scenario = sp.test_scenario(
        "Delete Generator with Sale Configuration", [svg_js, randomiser]
    )
...
def test_delete_multiple_generators():
    ...
    """
    scenario = sp.test_scenario("Delete Multiple Generators", [svg_js, randomiser])
    ...
    contract.delete_generator(2, _sender=alice)
    ...
    contract.delete_generator(0, _sender=alice, _valid=False)
...
def test_delete_generator_edge_cases():
    ...
    """
    scenario = sp.test_scenario("Delete Generator Edge Cases", [svg_js, randomiser])
    ...
    scenario.h2("Cannot delete non-existent generator")
    contract.delete_generator(999, _sender=alice, _valid=False)
...
def test_delete_generator_after_failed_mint():
    ...
    """
    scenario = sp.test_scenario(
        "Delete Generator After Failed Mint", [svg_js, randomiser]
    )
    ...
    contract.create_generator(
        ...
        description=sp.bytes(
            "0x54657374696e672064656c6574696f6e206166746572206661696c6564206d696e74"
        ),
        code=sp.bytes("0x636f6e736f6c652e6c6f67282254657374"),
        author_bytes=sp.bytes("0x416c696365"),
        reserved_editions=0,
